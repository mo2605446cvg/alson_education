...
class _ContentScreenState extends State<ContentScreen> {
  ...
  Widget _buildFileIcon(String fileType) {
    switch (fileType) {
      case 'pdf':
        return Icon(Icons.picture_as_pdf, size: 40, color: Theme.of(context).primaryColor);
      case 'jpg':
      case 'png':
      case 'jpeg':
        return Icon(Icons.image, size: 40, color: Theme.of(context).primaryColor);
      case 'txt':
        return Icon(Icons.text_snippet, size: 40, color: Theme.of(context).primaryColor);
      default:
        return Icon(Icons.insert_drive_file, size: 40, color: Theme.of(context).primaryColor);
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Padding(
        ...
        child: Column(
          children: [
            Text('المحتوى', style: Theme.of(context).textTheme.headlineLarge),
            SizedBox(height: 20),
            Row(
              children: [
                Expanded(
