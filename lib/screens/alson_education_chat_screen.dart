...
class AlsonEducationChatScreen extends StatefulWidget {
  const AlsonEducationChatScreen({super.key});

  @override
  _AlsonEducationChatScreenState createState() => _AlsonEducationChatScreenState();
}

class _AlsonEducationChatScreenState extends State<AlsonEducationChatScreen> {
