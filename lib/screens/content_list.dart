                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text('نوع الملف: ${content.fileType}', style: const TextStyle(color: textColor, fontFamily: 'Cairo')),
                                        Text('تم الرفع بواسطة: ${content.uploadedBy}', style: const TextStyle(color: textColor, fontFamily: 'Cairo')),
                                        Text('تاريخ الرفع: ${content.uploadDate}', style: const TextStyle(color: textColor, fontFamily: 'Cairo')),
                                      ],
                                    ),
                                  ),
                                  Row(
                                    children: [
                                      IconButton(
                                        ...
                                        onPressed: () async {
                                          final url = 'http://ki74.alalsunacademy.com/${content.filePath}';
