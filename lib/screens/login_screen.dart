...
class LoginScreen extends StatefulWidget {
  ...
  final Function(User) onLogin; // أضف هذا

  LoginScreen({required this.apiService, required this.onLogin}); // تعديل البناء
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _checkLoggedInUser() async {
    ...
    if (userData != null) {
      ...
      widget.onLogin(user); // استخدام onLogin بدلاً من التنقل مباشرة
    }
  }
      ...
      body: Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [
              Theme.of(context).primaryColorDark ?? Color(0xFF075E54),
