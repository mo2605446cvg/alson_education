  ...
  Future<void> _uploadContent() async {
    ...
    try {
      ...
      final content = Content(
        ...
        fileType: _fileType ?? '',
        filePath: '', // سيتم تعيينه بعد الرفع
          ...
          child: Column(
            children: [
              ...
              TextField(
                ...
                decoration: const InputDecoration(labelText: 'النبذة', hintStyle: TextStyle(fontFamily: 'Cairo')),
                style: const TextStyle(fontFamily: 'Cairo'),
              ),
              ...
              if (_filePath != null)
                Text('الملف المختار: $_fileType', style: const TextStyle(fontFamily: 'Cairo')),
              const SizedBox(height: 16),
              _isLoading
