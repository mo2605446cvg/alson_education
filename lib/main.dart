...
Future<void> main() async {
  ...
  try {
    await Supabase.initialize(
      ...
      anonKey: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZEIsInJlZiI6ImhzZ3FnamtyYm1rYXh3aG5rdGZ2Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTYyMTM1NDQsImV4cCI6MjA3MTc4OTU0NH0.WO3CQv-iHaxAin8pbS9h0CmDzfFC4Kb4sTaaYbBDM_Q',
    );
...
class _AlalsunAppState extends State<AlalsunApp> {
  ...
  void _startConnectionMonitoring() {
    _connectionSubscription = Stream.periodic(Duration(seconds: 30)).listen((_) {
  ...
  Future<void> _checkConnectionWithRetry() async {
    ...
    setState(() {
      _connectionError = 'فشل في الاتصال بالسيرفر بعد $maxRetries محاولات. يرجى التحقق من الإنترنت وإعادة المحاولة';
    });
  }
        ...
        body: Center(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 20),
              ElevatedButton(
                onPressed: _checkConnectionWithRetry,
                child: Text('إعادة المحاولة'),
              ),
              SizedBox(height: 10),
              TextButton(
                onPressed: _loginAsGuest,
                child: Text('الدخول كضيف للتصفح فقط'),
              ),
            ],
          ),
        ),
